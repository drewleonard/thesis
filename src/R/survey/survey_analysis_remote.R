...
# Load survey data
# 3259 responses
df_survey <- read.csv('IRA.csv')

# Load facebook data
df_fb <- read_csv("fb_gold.csv") %>%
...
# Make dtm sparse
dtm_sparse <- tm::removeSparseTerms(dtm, 0.999375)
...
saveRDS(sibp.search_10_999375_multi,
        'rds/sibp.search_10_999375_multi.RDS')

sibp.search_15_999375_multi <-
  texteffect::sibp_param_search(
    X,
    Y,
    K = 15,
...
saveRDS(sibp.search_15_999375_multi,
        'rds/sibp.search_15_999375_multi.RDS')

sibp.search_20_999375_multi <-
  texteffect::sibp_param_search(
    X,
    Y,
    K = 20,
...
saveRDS(sibp.search_20_999375_multi,
        'rds/sibp.search_20_999375_multi.RDS')